  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (otpVerified && changePassword) {
        ...
        const response = await fetch('https://hgpro.theworkflow.nyc/authentication/api/resend-otp', {
          method: 'POST',
          headers: {
        ...
        const response = await fetch('https://hgpro.theworkflow.nyc/authentication/api/forget-password-change', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
